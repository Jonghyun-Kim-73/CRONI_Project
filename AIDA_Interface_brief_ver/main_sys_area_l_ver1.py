...
class MainSysLeftArea(QGraphicsView):
    def __init__(self, parent, x, y, w, h):
        ...
        self._scene = MainSysLeftScene(self)
    ...
    def keyPressEvent(self, QKeyEvent):
        super(MainSysLeftArea, self).keyPressEvent(QKeyEvent)

class MainSysLeftScene(QGraphicsScene):
    def __init__(self, parent):
        super(MainSysLeftScene, self).__init__(parent)
        self.mem = parent.mem
        # SVG render ---------------------------------------------------------------------------------------------------
    ...
    def keyPressEvent(self, QKeyEvent):
        super(MainSysLeftScene, self).keyPressEvent(QKeyEvent)
...
class SVGComp(QGraphicsSvgItem):
    def __init__(self, svg_render, i: str, parent):
        ...
        self.pen_direction = self.sys_mimic_info[self.target_sys][i]['direction']  # Right, Left / Vertical, Horizontal
