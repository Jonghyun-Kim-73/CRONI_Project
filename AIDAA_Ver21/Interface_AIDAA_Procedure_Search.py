...
class XAISearchTable(ABCTableWidget):
    def __init__(self, parent, col_info:dict, widget_name=''):
        ...
        self.text_convert_num = {'Normal: 정상':0, 'Ab21_01: 가압기 압력 채널 고장 (고)':1, 'Ab21_02: 가압기 압력 채널 고장 (저)':2,
                                  ...
                                  'Ab63_02: 제어봉의 계속적인 삽입':6, 'Ab21_12: 가압기 PORV (열림)':7,
                                  'Ab19_02: 가압기 안전밸브 고장':8, 'Ab21_11: 가압기 살수밸브 고장 (열림)':9,
                                  'Ab23_03: CVCS에서 1차기기 냉각수 계통(CCW)으로 누설':10,
                                  'Ab59_02: 충전수 유량조절밸브 후단누설':11,
                                  'Ab23_01: RCS에서 1차기기 냉각수 계통(CCW)으로 누설':12, 'Ab23_06: 증기발생기 전열관 누설':13}
