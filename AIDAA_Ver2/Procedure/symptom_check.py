...
class symp_check:
    ...
    def abnormal_procedure_59_02(self):
        ...
        # 경보 및 증상 5: 1E RAD WARN ＆ HIGH ALARM(JP004)
        ...
        자동 동작 사항 0~7
        '''
        # 자동 동작 사항 0: 가압기 수위지시계 및 기록계(BB-LI459A/460, BB-LR459) 지시치 17%이하로 감소되면 다음과 같은 자동 동작이 발생한다.
        ...
        # 자동 동작 사항 7: 원자로보충수계통의 빈번한 자동 동작
