...
class WRMain1(ABCTableWidget, QTableWidget):
    def __init__(self, **kwargs):
        super(WRMain1, self).__init__(**kwargs)
        self.set_body()
        self.set_horizontal()
        self.set_vertical()
    ...
    def set_horizontal(self):
        ...
        [self.setColumnWidth(i + 1, s) for i, (_, s) in enumerate(col_info[1:])]
