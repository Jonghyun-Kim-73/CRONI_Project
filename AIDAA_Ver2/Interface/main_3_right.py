...
class Main3Right(QGraphicsView):
    def __init__(self, parent, x, y, w, h):
        super(Main3Right, self).__init__(parent)
        self.shmem = parent.shmem if parent is not None else None
        # --------------------------------------------------------------------------------------------------------------
        self.setAttribute(Qt.WA_StyledBackground, True)  # 상위 스타일 상속
        self.setAttribute(Qt.WA_TranslucentBackground)
        self.setMouseTracking(True)
        self.setObjectName('Main3Right')
        # Size ---------------------------------------------------------------------------------------------------------
    ...
    def keyPressEvent(self, QKeyEvent):
        super(Main3Right, self).keyPressEvent(QKeyEvent)
    ...
    def mousePressEvent(self, event: QMouseEvent) -> None:
        super(Main3Right, self).mousePressEvent(event)
...
class MainSysRightScene(QGraphicsScene):
    def __init__(self, parent):
        ...
        # SVG render ---------------------------------------------------------------------------------------------------
        self.svg_render = QSvgRenderer('./img/comp.svg')
        # Sys page info ------------------------------------------------------------------------------------------------
        self.target_sys = ''
        with open('./img/MMI.json', 'r', encoding='UTF-8-sig') as f:
    ...
    def save_all_mmi(self):
        print('SaveMMI')
        with open('./img/MMI.json', 'w', encoding='UTF-8-sig') as file:
...
if __name__ == '__main__':
    ...
    window = Main3Right(None, 0, 0, 900, 765)
    font = QFontDatabase()
